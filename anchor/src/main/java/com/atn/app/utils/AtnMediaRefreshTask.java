...
/**
 * <p>AtnTask enables proper and easy use of the UI thread. This class allows to
 ...
 *
 * <h2>Usage</h2>
 * <p>AtnTask must be subclassed to be used. The subclass will override at least
 * one method ({@link #doInBackground(Object[])}), and most often will override a
 * second one ({@link #onPostExecute(Object)}.)</p>
 *
 * <p>Here is an example of subclassing:</p>
 * <pre>
 * private class DownloadFilesTask extends AtnTask&lt;URL, Integer, Long&gt; {
 ...
 * <pre>
 * private class MyTask extends AtnTask<Void, Void, Void) { ... }
 * </pre>
 *
 * <h2>The 4 steps</h2>
 ...
 * </ul>
 */
public abstract class AtnMediaRefreshTask<Params, Progress, Result> {
    private static final String LOG_TAG = "AtnTask";
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "AtnTask #" + mCount.getAndIncrement());
        }
    };
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link AtnTask#onPostExecute(Object)} has finished.
         */
        FINISHED,
    }
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new UserTaskResult<Result>(AtnMediaRefreshTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new UserTaskResult<Result>(AtnMediaRefreshTask.this, result));
                message.sendToTarget();
            }
        };
    }
     ...
     * @param params The parameters of the task.
     *
     * @return This instance of AtnTask.
     *
     * @throws IllegalStateException If {@link #getStatus()} returns either
     *         {@link AtnMediaRefreshTask.Status#RUNNING} or {@link AtnMediaRefreshTask.Status#FINISHED}.
     */
    public final AtnMediaRefreshTask<Params, Progress, Result> execute(Params... params) {
    ...
    private static class UserTaskResult<Data> {
        final AtnMediaRefreshTask mTask;
        final Data[] mData;

        UserTaskResult(AtnMediaRefreshTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
