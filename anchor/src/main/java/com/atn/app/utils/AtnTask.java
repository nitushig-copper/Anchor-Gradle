 ...
 * </ul>
 */
public abstract class AtnTask<Params, Progress, Result> {
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new UserTaskResult<Result>(AtnTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new UserTaskResult<Result>(AtnTask.this, result));
                message.sendToTarget();
            }
        };
    }
     ...
     *         {@link AtnTask.Status#RUNNING} or {@link AtnTask.Status#FINISHED}.
     */
    public final AtnTask<Params, Progress, Result> execute(Params... params) {
    ...
    private static class UserTaskResult<Data> {
        ...
        UserTaskResult(AtnTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
