/*
 * Copyright (C) 2014 Coppermobile inc.
 *
 */
...
public class HttpManager {
    ...
    static {
        final HttpParams params = HttpUtility.getHttpParams();
	...
	public static HttpResponse executeOnSeperateClient(HttpUriRequest request)
			throws IOException {
		HttpParams httpParameters = HttpUtility.getHttpParams();
