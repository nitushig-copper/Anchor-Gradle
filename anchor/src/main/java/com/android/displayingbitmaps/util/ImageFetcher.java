...
public class ImageFetcher extends ImageResizer {
        ...
        synchronized (mHttpDiskCacheLock) {
            if (mHttpDiskCache != null && !mHttpDiskCache.isClosed()) {
                try {
                    ...
                    if (BuildConfig.DEBUG) {
                    	AtnUtils.log("HTTP cache cleared");
                    }
                } catch (IOException e) {
            ...
            if (mHttpDiskCache != null) {
                try {
                    if (!mHttpDiskCache.isClosed()) {
                        ...
                        mHttpDiskCache = null;
                        if (BuildConfig.DEBUG) {
                        	AtnUtils.log("HTTP cache closed");
                        }
                    }
                } catch (IOException e) {
    ...
    */
    ...
    private Bitmap processBitmap(String data) {
        if (BuildConfig.DEBUG) {
            AtnUtils.log("processBitmap - " + data);
        }
        ...
        synchronized (mHttpDiskCacheLock) {
            ...
            if (mHttpDiskCache != null) {
                try {
                    ...
                    if (snapshot == null) {
                        if (BuildConfig.DEBUG) {
                        	AtnUtils.log("processBitmap, not found in http cache, downloading...");
                        }
